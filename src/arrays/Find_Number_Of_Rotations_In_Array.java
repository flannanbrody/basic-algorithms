...
public class Find_Number_Of_Rotations_In_Array {

	/*
	 * We use a modified binary search to determine the pivot point around a rotated array.
	 * 
	 * Works if, no duplicates in array.
	 */
	public static void main(String[] args) {
		int[] a = { 12, 13, 14, 17, 20, 1, 3, 5, 7, 8, 11 };
		System.out.println("Output is: " + rotationPoint(a));

	}
	
	/*
	 * Pivot property is that next and previous are both greater.
	 */
	private static int rotationPoint(int[] rotates){
		//The key is to use a binary-search similar way to fast-find rotation place
		int start = 0;
		...
		while(start<end)
		{
			//Base case: the process is the sub-array is sorted!
