 ...
 *  the integers 1 to N^2 in ascending order, 
 *  1) Starting at the bottom, middle cell. Repeatedly assign the next integer to the
 *     cell adjacent diagonally to the right and down. 
 *  2) If this cell has already been assigned another integer, instead use the
