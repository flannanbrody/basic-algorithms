 ...
 */
public class LRU_Cache_Map_Of_Queues<K, V> {
    private HashMap<K, V> lru;
    private Queue<K> queue;
    private int max;

    public LRU_Cache_Map_Of_Queues(int n) {
        lru = new HashMap<K, V>();
    ...
    public static void main(String[] args) {
        LRU_Cache_Map_Of_Queues<String, Integer> lruCache = new LRU_Cache_Map_Of_Queues<String, Integer>(2);
