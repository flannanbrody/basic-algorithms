 ...
 */
public class LRU_Cache_Extends_LinkedHashMap<K,V> extends LinkedHashMap<K,V>{

    private int maxSize;

    // private static final long serialVersionUID = 1L;

    public LRU_Cache_Extends_LinkedHashMap(int size){
    ...
    public static void main(String[] args){
        ...
        LRU_Cache_Extends_LinkedHashMap<String, Integer> lru = new LRU_Cache_Extends_LinkedHashMap<String, Integer>(2);
