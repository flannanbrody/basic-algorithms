...
public class LongestBitonicSubsequence {
	 ...
	 * Subsequence (LIS) problem. Let the input array be arr[] of length n. We
	 * need to construct two arrays lis[] and lds[] using Dynamic Programming
	 * solution of LIS problem. lis[i] stores the length of the Longest
	 * Increasing subsequence ending with arr[i]. lds[i] stores the length of
	 * the longest Decreasing subsequence starting from arr[i]. Finally, we need
	...
	public static void main(String[] args) {
		...
		System.out.printf("Length of LBS is %d\n", lbs(arr));
	}
